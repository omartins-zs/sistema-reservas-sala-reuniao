...
<div class="px-4 py-6 sm:px-0">
    <div class="mb-8 flex justify-between items-center">
        ...
        <div class="flex space-x-3">
            <a href="{{ route('salas.edit', $sala) }}" class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700">
                Editar
            </a>
